...
// console.log(`${Number(number)}` + `${Number(numberic)}`); // ?Почему при применении шаблонных литералов происходит не сложение а склеивание
...
// let string3 = prompt('Введите предложение: Строка 3');
// let string2 = prompt('Введите предложение: Вторая строка');
// let string1 = prompt('Введите предложение: Строка номер раз');
...
// let num1 = Number(prompt('Введите число: 10'));
// let num2 = Number(prompt('Введите число: 20'));

// console.log(`(${num1} + ${num2}) x 3 = ${(num1 + num2) * 3}`);
