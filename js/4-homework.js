...
// let digits = x - y + String(Number(str)) + String(Number(str)) // ! не повторять дома !
// console.log(digits);
...
// let srt1 = prompt('Введите строку 1/3:');
// let srt2 = prompt('Введите строку 2/3:');
// let srt3 = prompt('Введите строку 3/3:');

// console.log(srt3);
// console.log(srt2.toUpperCase());
// console.log(srt1.toLowerCase());
...
// console.log(`(${number1} + ${number2}) × 3 = ${(number1 + number2) * 3}`);