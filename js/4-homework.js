...
// greatAmount = greatAmount - 99900;
// console.log(greatAmount);

// let hugeAmount = greatAmount + bigAmount;
...
// let srt1 = prompt('Введите строку:');
// let srt2 = prompt('Введите строку:');
// let srt3 = prompt('Введите строку:');

// console.log(srt1);
// console.log(srt2.toUpperCase());
// console.log(srt3.toLowerCase());
...
// console.log(`(${number1} + ${number2}) x 3 = ` + ((number1 + number2) * 3));